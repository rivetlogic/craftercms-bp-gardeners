  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="team_item team_skill">
        <div class="team_author">
          <@crafter.h4 $model=memberModel $field="fullName_t">
            ${memberModel.fullName_t}
          </@crafter.h4>
          <@crafter.p $model=memberModel $field="jobTitle_t">
    ...
    <div class="col-sm-4">
      <div class="team_item xs-m-top-30">
        <div class="port_img">
          <@crafter.img $model=memberModel $field="picture_s" src=(memberModel.picture_s) alt="" />
        </div>
      </div>
    </div><!-- End off col-sm-4 -->
    ...
    <div class="col-sm-4">
      <div class="team_item team_content xs-m-top-30">
        <#if memberModel.famousQuote_t != "">
          <@crafter.h4 $model=memberModel $field="famousQuote_t">
            ${memberModel.famousQuote_t}
          </@crafter.h4>
          <@crafter.h5 $model=memberModel $field="famousQuoteAuthor_t">
        ...
        <#if memberModel.socialMediaTitle_t != "">
          <div class="team_socail">
            <@crafter.h5 $model=memberModel $field="socialMediaTitle_t">
